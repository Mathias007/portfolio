export const aboutData = [
    {
        id: 1,
        subheader: "Na początek fora internetowe",
        paragraph: `
        <p>Swoją przygodę ze światem internetowym rozpocząłem w okolicach <strong>2005 roku</strong>. Kiedy już oswoiłem się z komfortem stałego łącza oraz poznałem podstawowe możliwości związane z dostępem do sieci, dość szybko postawiłem sobie za cel utworzenie własnych miejsc w tym wciąż jeszcze nieszczególnie w Polsce rozwiniętym środowisku internetowym. Ponieważ natrafiłem akurat na okres rosnącej popularności <strong>forów internetowych</strong>, to właśnie na ich budowaniu skupiłem się w początkowych latach aktywności.</p>
    ...
    {
        id: 2,
        subheader: "Tajemnice Antagarichu - pierwszy poważny projekt",
        paragraph: `
        <p>Mój pierwszy poważniejszy i długofalowy projekt stanowiło <strong>forum <a rel="noreferrer noopener" href="http://herosy3.pun.pl" data-type="URL" data-id="http://herosy3.pun.pl" target="_blank">www.herosy3.pun.pl</a></strong>, założone pod koniec <strong>2006 roku</strong>, traktujące o grze Heroes of Might and Magic III. Z biegiem lat otrzymało nazwę <strong>Tajemnice Antagarichu</strong>, a jego tematykę rozszerzono o pozostałe części sagi Heroes oraz inne gry z serii pokrewnych. Podczas kilkunastoletniego okresu prowadzenia forum miałem okazję poznać wielu ciekawych i utalentowanych internautów, którzy tworzyli wokół TA autonomiczną społeczność fanowską. Utrzymywałem także bliskie kontakty z twórcami portali, z którymi udało się zawiązać współpracę. Pozwoliło mi to nauczyć się wielu przydatnych rzeczy z zakresu <strong>tworzenia stron internetowych i podstaw grafiki komputerowej</strong>, jak również dotyczących <strong>rozwoju i promocji </strong>swoich dzieł w tym zakresie. Pierwsze lata prowadzenia TA wspominam jako okres burzliwych dyskusji i wytężonej pracy wespół ze świetnymi ludźmi z całej Polski (i nie tylko), które w dalszym okresie zaowocowały nawet możliwością współpracy z takimi gigantami jak <strong>Cenega Poland </strong>czy <strong>Ubisoft</strong> przy promocji ich wybranych produktów.</p>
    ...
    {
        id: 3,
        subheader: "Kroniki Heroes, czyli otwieramy się na wortal",
        paragraph: `
        <p>Ponieważ wokół forum funkcjonowała całkiem aktywna społeczność, działalność ulegała poszerzaniu. Jedną z form stanowiła <strong>strona internetowa</strong>, której pierwszą wersję - mającą stanowić download map do Heroes 3 - przygotował użytkownik <strong><em>Cohen</em></strong> w <strong>2008 roku</strong>. Kolejne odsłony, przy których miałem już przyjemność aktywnie uczestniczyć, przyjmowały różne nazwy (Biblioteka Heroes 3, Mroczna Biblioteka, <strong>Kroniki Heroes</strong>, TA Wortal). Termatyka serwisu z czasem się poszerzała, wpierw o statyczne treści dotyczące gry Heroes 3, następnie o materiały nt. innych części sagi, wreszcie o ogłoszenia i informacje bieżące ze świata Mocy i Magii.</p>
    ...
    {
        id: 4,
        subheader: "Komnata Pamięci - rezultat kronikarskiego podejścia",
        paragraph: `
    ...
    {
        id: 5,
        subheader: "Co poza Heroes? Strażnicy Etherii oraz Wieża Magów Tzar",
        paragraph: `<p>W międzyczasie zakładałem również inne fora i strony internetowe, a także uczestniczyłem w ciekawych inicjatywach oscylujących wokół gamingu. Wspomnieć wypada w tym miejscu o <strong>forum Strażnicy Etherii</strong> (<a rel="noreferrer noopener" href="http://wb2.pun.pl" data-type="URL" data-id="http://wb2.pun.pl" target="_blank"><strong>www.wb2.pun.pl</strong></a>), założonym w <strong>2008 roku</strong>, a dotyczącym serii Warlords Battlecry (zwł. części drugiej). Prowadziłem je niejako na zmianę z drugim administratorem <strong><em>Sauronem</em></strong>. Funkcjonowało ono <strong>do 2015 roku</strong>, a w związku z wygaśnięciem aktywności działalność była już kontynuowana po powołaniu <strong>eGildii Graczy</strong>.</p>
    ...
    {
        id: 6,
        subheader: "Aktywność sieciowa ery PBF",
        paragraph: `
    ...
    {
        id: 7,
        subheader: "Z serwera do szuflady... i z powrotem?",
        paragraph: `
        <p>Nie wszystkie bowiem inicjatywy kończyły się spodziewanym sukcesem. Często brakowało czasu i energii bądź odpowiedniego podejścia. Każde niepowodzenie stanowiło wszak cenną lekcję i pozwoliło wyciągnąć wnioski na przyszłość. Do przedwcześnie zarzuconych należał m. in. <strong>projekt forum tolkienowskiego (2009)</strong>, <strong>forumowej gry ,,Osada" (2008)</strong> czy też gangsterskiego PBF'a <strong>,,Omerta" (2014)</strong>. Zebrany w ich ramach content cierpliwie czeka w moich archiwach, by powrócić w zupełnie nowej formule w najmniej spodziewanym momencie :-).</p>
    ...
    {
        id: 8,
        subheader: "Prawnik vs. Informatyk - początek wielkiego dylematu",
        paragraph: `
    ...
    {
        id: 9,
        subheader: "eGildia Graczy, czyli nowe otwarcie",
        paragraph: `
        <p>Przełom nastąpił w styczniu <strong>2017 roku</strong> za sprawą powołania do życia <strong>serwisu gamingowego <a rel="noreferrer noopener" href="https://egildia.pl" data-type="URL" data-id="https://egildia.pl" target="_blank">eGildia Graczy</a> (egildia.pl)</strong>. Łączył on w dużej mierze owoce moich dotychczasowych aktywności sieciowych w spójną całość, a także umożliwił realizowanie zupełnie nowych pomysłów. Najważniejsze części portalu stanowią newsy ze świata gier oraz bardziej ponadczasowe artykuły (recenzje, solucje, kody i inne). Oprócz tego eGildia Graczy zawiera odrębne działy poświęcone wybranym kultowym tytułom. Całość dopełnia sekcja literacka, obejmująca twórczość internautów tworzących w poprzednich latach społeczności na prowadzonych przeze mnie forach (zwł. TA i SE).</p>
    ...
    {
        id: 10,
        subheader: "Komercjalizacja działalności - projekty i praca",
        paragraph: `
        <p>Sukces eGildii Graczy spowodował, że coraz poważniej brałem pod uwagę sprofesjonalizowanie działalności w webdevie oraz podążanie programistyczną ścieżką zawodową. Z tego względu w latach <strong>2018-2019</strong> korzystałem z możliwości <strong>komercyjnego tworzenia i rozwijania stron internetowych</strong> dla moich ówczesnych pracodawców (kancelarii prawnych). Z tego okresu pochodzą m. in. strony <strong>bislaw.pl</strong> oraz <strong>muzykapiekna.pl</strong>.</p>

        <p>To też czas, kiedy za naukę programowania wziąłem się naprawdę poważnie. Z pomocą certyfikowanych kursów internetowych pogłębiłem swoją wiedzę na temat <strong>HTML 5</strong>, <strong>CSS (3)</strong>, <strong>JavaScript ES6+</strong> oraz <strong>REST API</strong>. Poznałem także <strong>React.js</strong>, jak również preprocesor <strong>SASS/SCSS</strong>. Na backendzie podjąłem się nauki <strong>Node.js i Expressa</strong> czy <strong>MongoDB</strong>. Zacząłem też korzystać z <strong>Gita</strong> oraz oswoiłem się z IDE <strong>Visual Studio Code</strong>.</p>
    ...
    {
        id: 11,
        subheader: "Własna aktywność - projekt eGildia 2.0",
        paragraph: `
        <p>Wzbogacony nowymi doświadczeniami w <strong>listopadzie 2019 roku </strong>przystąpiłem do prac nad własnym <strong>długofalowym projektem fullstackowym</strong> pod roboczą nazwą ,,<strong>eGildia 2.0</strong>". W założeniu ma on stanowić zbudowany od podstaw portal, wyposażony w panel administratora, system autoryzacji i autentykacji użytkownika oraz wygodny interfejs do dodawania treści z poziomu przeglądarki. Tematyka - a jakże - gamingowa. Docelowo projekt mógłby wspomóc bądź nawet częściowo zastąpić wordpressową wersję serwisu eGildia Graczy. Głównym jednak celem jest stworzenie maksymalnie uniwersalnego i re-używalnego systemu do wykorzystania przy tworzeniu różnorodnych serwisów internetowych.</p>
    ...
    {
        id: 12,
        subheader: "Pandemiczna rzeczywistość i praca asystenta sędziego",
        paragraph: `
        <p>W <strong>marcu 2020 roku</strong> podjąłem pracę asystenta sędziego w Wojewódzkim Sądzie Administracyjnym w Gliwicach. Sytuacja wywołana pandemią COVID-19 skłoniła mnie do podjęcia decyzji, że ten trudny czas spędzę na stanowisku prawniczym, zgodnie ze zdobytym niespełna rok wcześniej wykształceniem. Ponieważ w <strong>czerwcu 2020 roku</strong> ukończyłem dodatkowo studia z zakresu administracji, wybór ten znalazł podwójne uzasadnienie.</p>
    ...
    {
        id: 13,
        subheader: "W kierunku kariery programistycznej",
        paragraph: `
        <p>Po godzinach zaś pisałem kod, tworząc mniejsze i większe projekty, udostępniane na <strong><a rel="noreferrer noopener" href="https://github.com/Mathias007" data-type="URL" data-id="https://github.com/Mathias007" target="_blank">Githubie </a></strong>zazwyczaj wraz z preview. Na chwilę obecną posiadam kilkadziesiąt repozytoriów, a ich ilość i jakość zwiększa się z czasem. Od <strong>początku 2021 roku </strong>programowaniu poświęcam większość wolnego czasu, rozwijając dotychczasowe projekty i ucząc się nowych technologii i rozwiązań. Wspomniałem już m. in. o r<strong>efaktoryzacji Tajemnic Antagarichu i Komnaty Pamięci</strong>. Szczególną wagę przywiązuję obecnie do programowania obiektowego w webdevelopmencie oraz rozwijania w kierunku bardziej fullstackowym (choć wciąż z naciskiem na frontend). Stąd chociażby zainteresowanie <strong>TypeScriptem</strong>, <strong>NestJS</strong> czy <strong>Pythonem</strong>, a także odświeżanie i pogłębianie wiedzy dotyczącej <strong>PHP</strong> i <strong>MySQL</strong>. Najwięcej jednak uwagi poświęcam <strong>vanilla JavaScript</strong> oraz <strong>React.js</strong>, przy czym planuję również zbudowanie niektórych projektów z wykorzystaniem <strong>Angulara </strong>lub <strong>Vue</strong>, aby mieć choćby podstawowe rozeznanie w innych frameworkach frontendowych.</p>
